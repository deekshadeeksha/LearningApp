...
public class OrangeColorFrag extends Fragment {
    ImageView b, l, u, e;
    MediaPlayer song,song1,song2,song3,song4,song5,song6;

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_orange_color_frag, container, false);

        int[] imageButtonIds = {R.id.oo, R.id.or, R.id.oa, R.id.on, R.id.og, R.id.oe};
        int[]audio=new int[]{R.raw.o,R.raw.r,R.raw.a,R.raw.n,R.raw.g,R.raw.e,R.raw.orange};
        // Array of textViews
        ...
        song5 = MediaPlayer.create(getContext(),audio[5]);
        song4.setNextMediaPlayer(song5);
        song6 = MediaPlayer.create(getContext(),audio[6]);
