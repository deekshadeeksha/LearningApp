...
public class PuzzleLV1Part3 extends AppCompatActivity {
    ...
    public static boolean currentstatel13;
    public static int piececount=0;
    private static PuzzleLV1Part3 myActivity ;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_puzzle_lv1_part3);
        ...
        myActivity=PuzzleLV1Part3.this;
    ...
    public void goBackpl13(View v)
    {
        currentstatel13=false;
        this.finish();
    }
    public void onStart() {
        super.onStart();
        currentstatel13 = true; //Store status of Activity somewhere like in shared //preference
    }
