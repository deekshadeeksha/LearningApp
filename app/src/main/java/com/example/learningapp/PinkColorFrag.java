...
public class PinkColorFrag extends Fragment {
    ImageView b, l, u, e;
    MediaPlayer song,song1,song2,song3,song4;
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_pink_color_frag, container, false);

        int[] imageButtonIds = {R.id.pp, R.id.pi, R.id.pn, R.id.pk};
        int[]audio=new int[]{R.raw.p,R.raw.i,R.raw.n,R.raw.k,R.raw.pink};
        // Array of textViews
