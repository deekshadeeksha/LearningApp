...
public class PuzzleLV1Part2 extends AppCompatActivity {
    ArrayList<PuzzlePiece> pieces;
    ImageView otherpic1,otherpic2;
    int[] photos={R.drawable.giraffeshadowsmall};
    ...
    public static boolean currentstatel12;
    public static int piececount=0;
    private static PuzzleLV1Part2 myActivity ;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_puzzle_lv1_part2);
        ...
        myActivity=PuzzleLV1Part2.this;
    ...
    public void goBackpl12(View v)
    {
        currentstatel12=false;
        this.finish();
    }
    public void onStart() {
        super.onStart();
        currentstatel12 = true; //Store status of Activity somewhere like in shared //preference
    }
